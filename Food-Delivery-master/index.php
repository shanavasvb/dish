...
?>
    ...
    <div class="paragraph1">
          ...
          <p>
            <h3>
              <span class="glyphicon glyphicon-ok tickicon"></span> <u>SELECT YOUR DISH</u>
            </h3>
          </p>
          <p>
            <h4>
              You select as per your choice of dishes from the list serving <font color="green"><strong>cuisines like Italian, Chinese dishes, Hyderabadi, North Indian,</strong></font> Burgers or Desserts like Ice-cream or Cakes.
            </h4>
          </p>
          <br>
          <p>
          ...
          <p>
            <h4>
              That’s all once everything is in order hit on the checkout and pays online or cash on delivery, choose the way you want we accept all major credit cards or pay cash on delivery. <font color="green"><strong>You can order food online.</strong></font>
            </h4>
          </p>
          <br>
          <p>
